...
WebUI.setText(findTestObject('Page_Search Filter  Merlin The Wizard/input_Search by Phone Number_mobile_no'), '254799596280')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Create New Interaction Detail  Merlin The Wizard/select_Customer FollowupPromise to PayTraining FollowupSpoof CallingSurprise VisitAsset List Confirmation'), 
    'Customer Followup', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Create New Interaction Detail  Merlin The Wizard/select_556428 - 500000'), 
    '556428', true)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Create New Interaction Detail  Merlin The Wizard/select_4G Staff Error4G Systen ErrorAdverse Business CycleAirtel Network DownBFC'), 
    '2', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Create New Interaction Detail  Merlin The Wizard/select_AnsweredAnswered BFC Answered Disputes amountAnswered Will Call'), 
    '3', true)
