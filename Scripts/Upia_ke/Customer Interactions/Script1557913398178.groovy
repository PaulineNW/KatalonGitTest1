...
WebUI.click(findTestObject('Object Repository/Page_Dashboards  Merlin The Wizard/a_Followup'))

WebUI.click(findTestObject('Object Repository/Page_Dashboards  Merlin The Wizard/a_Customer Interactions'))

WebUI.click(findTestObject('Object Repository/Page_Customer Interactions  Merlin The Wizard/a_Interactions due today'))
