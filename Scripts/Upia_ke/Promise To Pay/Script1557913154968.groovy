...
WebUI.click(findTestObject('Object Repository/Page_Dashboards  Merlin The Wizard/a_Promise To Pay (PTP)'))

WebUI.click(findTestObject('Object Repository/Page_Promise to Pay (PTP)  Merlin The Wizard/a_PTPs due today'))
