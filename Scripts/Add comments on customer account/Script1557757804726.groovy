...
WebUI.setText(findTestObject('Page_Search Filter  Merlin The Wizard/input_Search by Phone Number_mobile_no'), '254790449336')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Customer Details  Merlin The Wizard/select_000'), '2500', 
    true)

WebUI.setText(findTestObject('Object Repository/Page_Customer Details  Merlin The Wizard/textarea_Comments on the Customer_customer_comments'), 
    'test')
