...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Update Loan Application Detail(s)  Merlin The Wizard/select_Collections Cell Mercy MwangiCollections Cell Sizzlar'), 
    '31', true)
